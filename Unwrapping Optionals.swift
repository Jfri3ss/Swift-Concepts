 ...
 */
// Test variables
var itemGathered: String? = "The sword of 1000 truths"
var isShopOpen: Bool?
...
// Optional binding (if let statment) saying if "itemGathered" is not nil, then unwrap the value and assign it to item
...
if let isShopOpen = isShopOpen, let searchedItem = blacksmithShop["Shield"] {
    print("We are open \(isShopOpen) and we have a \(searchedItem) in stock")
} else {
